...
// GET /api/map-markers?meetingId=xxx[&submittedOnly=true]
// submittedOnly=true: submissions.submitted_at IS NOT NULL 인 팀의 마커만 반환
export async function GET(req: NextRequest) {
  ...
  // submittedOnly 일 때: 실제 자료제출(submitted_at NOT NULL)한 팀 ID만 추려서 필터
  ...
  if (allowedTeamIds !== null) {
    // 제출한 팀이 아무도 없으면 빈 배열 반환 (in([]) 는 오류 방지용 더미)
